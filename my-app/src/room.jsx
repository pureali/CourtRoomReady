...
export default function App() {
  const judgeAvatarRef = useRef();
  const handleStartChat = () => {
    
    if (judgeAvatarRef.current && judgeAvatarRef.current.startChat) {
      judgeAvatarRef.current.startChat();
  ...
  <div className="app-container" style={{ 
    ...
    <div className="content" style={{
      ...
      <div style={{
        ...
        <Avatar ref={judgeAvatarRef} style={{ transform: 'scale(1.0)' }} title="Judge" />
        <button onClick={handleStartChat} style={{ marginTop: '12px' }}>Start Judge Chat (from App)</button>
      </div>
